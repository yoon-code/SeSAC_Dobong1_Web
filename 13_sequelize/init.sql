...
-- ------새로운 user 만들기1
CREATE USER 'sesac'@'%' IDENTIFIED BY '0000';

ALTER USER 'sesac'@'%' IDENTIFIED WITH mysql_native_password BY '0000';
-- 비밀번호 바꾸고 싶다면!


-- ------새로운 user만들기2
CREATE USER 'sesac'@'%' IDENTIFIED WITH mysql_native_password BY'0000';
